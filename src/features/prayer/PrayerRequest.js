  ...
  if (active === null) {
    ...
    result =
      <div className={styles.requestForm}>
        ...
        <h2>Vi försöker ha förebedjare tillgänglig via telefon varje söndag.<br />Om förebedjare finns är förbönen öppen efter söndagens gudstjänst mellan 13.00 och 13.45.</h2>  
      </div>;
  } else if (submitted) {
    result =
        <div className={styles.requestForm}>
